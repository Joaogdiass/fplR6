...
export const players: PlayerStats[] = [
  ...
  { player: "Mxchine7.", victory: 0, defeat: 3,  kills: 36, assists: 7, deaths: 35, roundsWon: 18, roundsLost: 29, avatar: "https://ui-avatars.com/api/?name=Mxchine7.&background=0D8ABC&color=fff" },
  { player: "Te_Drop17", victory: 0, defeat: 3,  kills: 14, assists: 6, deaths: 38, roundsWon: 18, roundsLost: 29, avatar: "https://ui-avatars.com/api/?name=Te_Drop17&background=0D8ABC&color=fff" },
  { player: "bocao.", victory: 1, defeat: 2,  kills: 34, assists: 9, deaths: 35, roundsWon: 24, roundsLost: 24, avatar: "https://ui-avatars.com/api/?name=bocao.&background=0D8ABC&color=fff" },
  ...
  { player: "yFeHx", victory: 1, defeat: 1,  kills: 18, assists: 4, deaths: 22, roundsWon: 18, roundsLost: 17, avatar: "https://ui-avatars.com/api/?name=yFeHx&background=0D8ABC&color=fff" },
];
